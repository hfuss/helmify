# Helmify
[![CI](https://github.com/onelapahead/helmify/actions/workflows/ci.yml/badge.svg)](https://github.com/onelapahead/helmify/actions/workflows/ci.yml)
![GitHub go.mod Go version](https://img.shields.io/github/go-mod/go-version/onelapahead/helmify)
![GitHub](https://img.shields.io/github/license/onelapahead/helmify)
![GitHub release (latest by date)](https://img.shields.io/github/v/release/onelapahead/helmify)
[![Go Report Card](https://goreportcard.com/badge/github.com/onelapahead/helmify)](https://goreportcard.com/report/github.com/onelapahead/helmify)
[![GoDoc](https://godoc.org/github.com/onelapahead/helmify?status.svg)](https://pkg.go.dev/github.com/onelapahead/helmify?tab=doc)
![GitHub total downloads](https://img.shields.io/github/downloads/onelapahead/helmify/total)
...
See [examples](https://github.com/onelapahead/helmify/tree/main/examples) of charts generated by helmify.
...
- With operator-sdk version < v1.23.0 
    ...
    helmify:
    	$(call go-get-tool,$(HELMIFY),github.com/onelapahead/helmify/cmd/helmify@v0.3.7)
...
- With operator-sdk version >= v1.23.0
    ...
    $(HELMIFY): $(LOCALBIN)
    	test -s $(LOCALBIN)/helmify || GOBIN=$(LOCALBIN) go install github.com/onelapahead/helmify/cmd/helmify@latest
...
With [Homebrew](https://brew.sh/) (for MacOS or Linux): `brew install onelapahead/tap/helmify`

Or download suitable for your system binary from [the Releases page](https://github.com/onelapahead/helmify/releases/latest).
